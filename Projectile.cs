...
public class Projectile : MonoBehaviour {
	...
	[Header("Damage types for different weapons")]
	public float damage;
	...
	private void OnCollisionEnter (Collision collision)
	{
		...
		// If the bullet collides with a Zombie
	// If the bullet collides with a Zombie
...
{
    // Apply damage
    zombie.TakeDamage(damage); // <-- Change this per weapon if needed

    // Optional: Spawn blood impact
